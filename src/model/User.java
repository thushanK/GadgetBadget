...
public class User {
	...
	//to create new user
	public String insertUser(String LastName , String FirstName , String Email, String Password, String Country, String ContactNumber)
	 {
	 String output = "";
	 try
	 {
	 ...
	 String query = " insert into items (`userID `,`LastName`,`FirstName`,`Email`,`Password`,`Country`,`ContactNumber`)" + " values (?, ?, ?, ?, ?, ?, ?)";
